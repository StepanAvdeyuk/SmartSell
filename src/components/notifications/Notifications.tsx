...
const data = [
    {
        date: '24.07.2022',
        message: 'Возникла проблема с заказом #113-0056743-0973009 Осталось меньше суток для отправки [Koethier 35301 17 inch Mdieval Knights Chess Set]'
    },
    {
        date: '24.07.2022',
        message: 'Возникла проблема с заказом #113-0056743-0973009 Осталось меньше суток для отправки [Koethier 35301 17 inch Mdieval Knights Chess Set]'
    ...
    <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
            <div className={styles.sort}>
                ...
                <div className={styles.sortSystem}>
                    Уведомления системы
                    <svg width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 1.25L4 4.75L7.5 1.25" stroke="#227AFF" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
            ...
            {data.map((item, i) => {
                return <div className={styles.problem}>
                    ...
                    <div className={styles.problemText}>{item.message}</div>
                </div>
            })}
        </div>
    </div>
